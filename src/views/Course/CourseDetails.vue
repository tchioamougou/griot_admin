  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      ...
      <div class="text-center md:text-left">
        ...
        <div class="w-16 h-1 bg-gradient-to-r from-pink-400 to-yellow-400 rounded-full mt-2 mx-auto md:mx-0"></div>
      </div>
...
<section class="relative min-h-[400px] flex items-center overflow-hidden">
  ...
  <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-4">
      <span class="inline-block px-4 py-2 bg-white/20 rounded-full text-sm font-semibold backdrop-blur-sm border border-white/30 text-white">
        {{ certificate ? '🏆 Certifiant' : '📚 Formation' }}
      </span>
    </div>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center gap-8 mb-8">
      ...
      >
        ...
        <div>
          ...
          <p v-if="instructors.email" class="text-white/80 text-sm">📧 {{ instructors.email }}</p>
          <p class="text-white/80 text-sm">{{ instructors?.headLine }}</p>
          <p class="text-white/80 text-sm">⭐ Note : {{ instructors.rating ?? 0 }}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-2xl">
        <div class="text-center">
          ...
          <p class="text-sm text-white/80">Étudiant{{ course.totalEnrolled > 1 ? 's' : '' }}</p>
        </div>
        <div class="text-center">
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-white/80">Leçons</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="max-w-7xl ">
          <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
              <div class="bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 hover:-translate-y-2">
                <div class="p-8">
                  <div class="flex items-center gap-4 mb-6">
                    <h3 class="text-2xl font-bold text-gray-900">Informations du Cours</h3>
                    <div class="flex-1 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full"></div>
                  </div>

                  <!-- Info Grid -->
                  <div class="grid md:grid-cols-2 gap-4 mb-8">
                    <div class="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl hover:from-blue-100 hover:to-indigo-100 transition-colors duration-300">
                      <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center text-white text-xl">
                        📅
                      </div>
                      <div>
                        <p class="text-sm text-gray-600">Date de sortie</p>
                        <p class="font-semibold text-gray-900">{{ formatDate(course.lastModifyDate) }}</p>
                      </div>
                    </div>

                    <div class="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl hover:from-green-100 hover:to-emerald-100 transition-colors duration-300">
                      <div class="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-white text-xl">
                        🌍
                      </div>
                      <div>
                    ...
                    <div class="flex items-center gap-4 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl hover:from-yellow-100 hover:to-orange-100 transition-colors duration-300">
                      <div class="w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center text-white text-xl">
                        🏆
                      </div>
                      <div>
                        <p class="text-sm text-gray-600">Certificat</p>
                        <p class="font-semibold text-gray-900">{{ certificate ? 'Inclus' : 'Non inclus' }}</p>
                      </div>
                    </div>

                    <div class="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl hover:from-purple-100 hover:to-pink-100 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    ></div>
                    <p v-else class="text-gray-500 italic">Aucune description disponible pour ce cours.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <!-- Earnings Card -->
              <div class="bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
                <div class="p-6">
                  <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Revenus du Cours</h3>
                    <div class="flex items-center gap-1 px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                  ...
                  <div class="flex items-end justify-center gap-2 h-24 mb-4">
                    <div class="w-6 bg-gradient-to-t from-purple-500 to-purple-300 rounded-t-lg animate-pulse" style="height: 60%"></div>
                    <div class="w-6 bg-gradient-to-t from-purple-500 to-purple-300 rounded-t-lg animate-pulse" style="height: 80%; animation-delay: 0.2s"></div>
                    <div class="w-6 bg-gradient-to-t from-purple-500 to-purple-300 rounded-t-lg animate-pulse" style="height: 45%; animation-delay: 0.4s"></div>
                    <div class="w-6 bg-gradient-to-t from-purple-500 to-purple-300 rounded-t-lg animate-pulse" style="height: 90%; animation-delay: 0.6s"></div>
                    <div class="w-6 bg-gradient-to-t from-purple-500 to-purple-300 rounded-t-lg animate-pulse" style="height: 70%; animation-delay: 0.8s"></div>
                  </div>
              ...
              <div class="bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
                <div class="p-6">
                  <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">
                      <i class="bi bi-arrow-up"></i>
                      <span>+0%</span>
                    </div>
                  </div>
                  ...
                  <div class="text-center">
                    <div class="relative w-24 h-24 mx-auto mb-4">
                      ...
                      <div class="absolute inset-2 rounded-full bg-white flex items-center justify-center">
                        <span class="text-xl font-bold text-gray-900">{{course.enrolledThisMonth}}</span>
                      </div>
                      <svg class="absolute inset-0 w-24 h-24 transform -rotate-90" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10" stroke="url(#gradient)" strokeWidth="2" fill="none" strokeDasharray="63" strokeDashoffset="16" strokeLinecap="round">
                          <defs>
                    ...
                    <p class="text-sm text-gray-600">nouvelles inscriptions ce mois</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 pb-8 border-b border-gray-200">
            <div>
              <h2 class="text-3xl font-bold text-gray-900 mb-2">Avis des Étudiants</h2>
              <p class="text-gray-600">Découvrez ce que pensent nos étudiants</p>
            </div>
            ...
            <div class="flex items-center gap-4 mt-4 md:mt-0">
              ...
              <div class="flex">
                <span v-for="star in 5" :key="star"
                      :class="['text-2xl', star <= Math.floor(course.reviews) ? 'text-yellow-400' : 'text-gray-300']">
                  ★
                </span>
              </div>
            </div>
...
const columns: any[] = [
  ...
  { name: 'email', label: 'Date', type: 'url', event: 'viewProfile' },
  { name: 'showPrice', label: 'Rating', type: 'text' },
  {
    name: 'actions',
    label: 'Actions',
    type: 'action',
